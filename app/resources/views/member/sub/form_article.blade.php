...
<div class="px-4 py-8">
    ...
    <div class="flex flex-col space-y-8">
        ...
        <div class="w-full">
            ...
            <textarea form="main_form" id="new_content" name="content" class="w-full form-active-blue text-opacity-10 minh-300px"
        ...
        <div class="py-1 w-full flex flex-wrap flex-col space-y-4 md:space-y-0 justify-start md:flex-row md:items-end">
            ...
            <x-forms.radio form="main_form" name="status_id" :items="$articleStatuses" key="id" value="name" :checked="(int)($formValue['status_id'])"/>
        ...
        {{-- form buttons --}}
        <div class="flex flex-col md:space-y-0 md:flex-row md:space-x-4 gap-4 items-center">
            <div class="flex w-full justify-around">

                <div class="flex items-center justify-center">
                    @if ($action === 'edit')
                        <x-forms.button form="main_form" id="btn_edit" class="btn-green"
                            formaction="{{ route('article.update', ['article' => $id]) }}">
                            {{ __('Edit') }}
                        </x-forms.button>
                    @else
                        <x-forms.button form="main_form" id="btn_post" class="btn-blue"
